...
\begin{document}
    ...
    \begin{enumerate}
        \item \textit{(1 балл)} Какое максимальное количество королей можно поместить на шахматную доску 8 х 8 так, чтобы эти короли не били друг друга?
        
        Еще тут чето хочу пописать
        
        \item Задача намба ту
    \end{enumerate}
